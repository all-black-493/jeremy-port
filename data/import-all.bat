...
set FILES=skills.ndjson profile.ndjson education.ndjson experience.ndjson projects.ndjson blog.ndjson achievements.ndjson testimonials.ndjson navigation.ndjson siteSettings.ndjson contact.ndjson
