...
export default defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: "string",
            description: "e.g., DevOps & Backend Engineer",
            validation: (Rule) => Rule.required()
        }),
        defineField({
            ...
            type: "string",
            description: "The static part of the animated headline (e.g. I build)",
            placeholder: "I build"
        }),
        defineField({
        ...
        defineField({
            ...
            type: "text",
            rows: 3,
            description: "Brief self-introduction (2-3 sentences)",
        ...
        defineField({
            ...
            fields: [
                ...
                { name: "slack", title: "Slack", type: "url" },
